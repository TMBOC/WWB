function [WWB] = BZB_evaluate_0327_v2(kappa_vec, SNR_dB_vec, mu_vec, K_vec, group_vec)
                    ...
                    for jj=1:length(hv)
                        ...
                        ph4 = (1/besseli(0, kappa)) * exp(kappa * ...
                                                                ((1-si-sj)*cos(2*pi*(v+d)-mu) ...
                                                                  + (si-1)*cos(2*pi*(v+d)-mu-max(hi,hj)) ...
                                                                  + (sj-1)*cos(2*pi*(v+d)-mu-min(hi,hj))));
                        ...
                        ph1 = (1/besseli(0, kappa)) * exp(kappa * ...
                                                                ((si+sj-1)*cos(2*pi*v-mu-min(hi,hj)) ...
                                                                  - si*cos(2*pi*(v+d)-mu) ...
                                                                  - sj*cos(2*pi*v-mu))...
                                );
